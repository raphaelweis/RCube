...
fun ActivateProfileDialog(
    ...
    AlertDialog(icon = {
        ...
        Text(text = stringResource(R.string.activate_profile_dialog_title))
    }, text = {
        Text(text = stringResource(R.string.activate_profile_dialog_body))
